      ...
      <div className="flex gap-8">
        ...
        <div className="fixed w-[400px] pt-8">
          <h1 className="text-[40px] font-serif leading-tight">
            ...
            Report
            <br />
            <span className="text-lg font-sans text-gray-600">Healthcare Provider View</span>
          </h1>
        </div>
        ...
        <div className="flex-1 ml-[400px]">
          ...
          {/* 2. Clinical Notes Section (Healthcare Providers) */}
          ...
          {/* 3. Questions & Answers Section - Enhanced UI */}
          {filteredQuestions.length > 0 && (
            <div className="mb-8">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-medium">Patient Responses</h2>
              </div>
              <div className="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-100">
          ...
          <div className="mb-8">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-medium">Suggestions for Patient</h2>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          {/* 5. Recommended Medications Section */}
              ...
              <div className="mb-6 p-4 bg-gray-50 border-l-4 border-primary rounded-r-lg text-sm">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700">
                    The patient has been informed that these medications are for informational purposes only and advised to consult with you before starting any new treatment. Please review these recommendations as part of your comprehensive care plan.
                  </p>
                </div>
              </div>
                ...
                {otcMedications.map((med, index) => (
                  <div key={index} className="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-100 hover:shadow-md transition-shadow duration-300">
                    ...
                    <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center">
                      ...
                      <span className="text-sm text-gray-500">Patient advised to consult you before use</span>
                    </div>
                  </div>
                ))}
              </div>
...
AdminReportSection.defaultProps = {
  otcMedications: [],
  clinicalNotes: [],
  questions: [],
};
