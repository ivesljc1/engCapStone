      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <Button 
            ...
            className={`rounded-full ${selectedStatus === "all" ? "bg-[#D7A8A0] text-white hover:bg-[#c49991]" : ""}`}
          >
            All
          </Button>
          <Button 
            ...
            className={`rounded-full ${selectedStatus === "scheduled" ? "bg-blue-600 text-white hover:bg-blue-700" : ""}`}
          >
            Scheduled
          </Button>
          <Button 
            ...
            className={`rounded-full ${selectedStatus === "completed" ? "bg-green-600 text-white hover:bg-green-700" : ""}`}
          >
            Completed
          </Button>
          <Button 
            ...
            className={`rounded-full ${selectedStatus === "cancelled" ? "bg-red-700 text-white hover:bg-red-800" : ""}`}
          >
            Cancelled
          </Button>
        </div>
            ...
            {filteredAppointments.length === 0 ? (
              ...
              filteredAppointments.map((appointment) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <AppointmentStatusBadge appointmentStatus={appointment.appointmentStatus} />
                  </td>
